...
class BiFPN(nn.Module):
    ...
    def __init__(self, num_channels, conv_channels, first_time=False, epsilon=1e-4, onnx_export=False, attention=True):
        ...
        # Upsampling layers for bottom-up path
        ...
        # Layers to align input feature maps [p3, p4, p5] extracted by efficientnet
        ...
        if self.first_time:
            ...
            # Layers to generate high-level feature maps [p6, p7]
    ...
    def _forward_fast_attention(self, inputs):
        if self.first_time:
            ...
            p6_in = self.p5_to_p6(p5) # is this not p5_in? no difference?
